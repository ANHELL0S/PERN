        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between p-4">
                    <Link
                        to={DASHBOARD_PATH}
                        className="flex items-center gap-3 text-neutral-700 rounded-md"
                    >
                ...
                <div className="flex-grow overflow-y-auto pr-3">
                    <div className="pl-4 flex flex-col gap-2 pt-2">
                        {!isCollapsed ? (
                            <p className="text-base font-medium">Section 1</p>
                        ) : (
                            <hr className="pb-4" />
                        )}
                    ...
                    <div className="pl-4 flex flex-col gap-2 pt-6">
                        {!isCollapsed ? (
                            <p className="text-base font-medium">Section 2</p>
                        ) : (
                            <hr className="pb-4" />
                        )}
                        <ul className="space-y-2 flex flex-col justify-center items-start">
                    ...
                    <div className="pl-4 flex flex-col gap-2 pt-6">
                        {!isCollapsed ? (
                            <p className="text-base font-medium">Section 3</p>
                        ) : (
                            <hr className="pb-4" />
                        )}
                        <ul className="space-y-2 flex flex-col justify-center items-start">
