        ...
        <div className="space-y-6">
            <div className="sm:grid sm:grid-cols-3 gap-4">
                ...
                <div className="col-span-2 space-y-8 pt-10">
                    ...
                    <div
                        id="info"
                        className={`relative ${activeSection !== 'info' && 'hidden'}`}
                    >
                        <h3 className="font-semibold text-lg mb-2">
                            Datos personales
                        </h3>
                        <p className="text-sm mb-4">
                            Complete su información personal a continuación para
                            mantener su cuenta actualizada.
                        </p>
                    ...
                    <div
                        id="security"
                        className={`relative ${activeSection !== 'security' && 'hidden'}`}
                    >
                        <h3 className="font-semibold text-lg mb-2">
                            Seguridad
                        </h3>
                        <p className="text-sm mb-4">
                            Administre su contraseña y revise la última vez que
                            se actualizó.
                        </p>
