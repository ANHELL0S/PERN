...
const Button = ({ type = 'button', variant = 'primary', size = 'sm', loading = false, children, onClick }) => {
	const baseClasses =
	...
	const variantClasses = {
		...
		rounded: 'border border-neutral-300 bg-white rounded-full text-neutral-600 hover:bg-neutral-200',
	}
	const sizeClasses = {
